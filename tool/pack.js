...
// Source copied over from archived repo https://github.com/darkskyapp/tz-lookup-oss for safekeeping
// Note 2025/02/12: Applied changes from https://github.com/photostructure/tz-lookup to start using 2025a
...
const urban_geojson = require("./dist/ne_10m_urban_areas.json");
...
fs.writeFileSync("dist/tz_data.txt", JSON.stringify(tz_data));
fs.writeFileSync("dist/tz_data_base64.txt", btoa(tz_data));
fs.writeFileSync("dist/tz_list.txt", JSON.stringify(tz_list));
